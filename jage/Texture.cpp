...
bool Texture::init(unsigned int width, GLenum internalFormat, GLenum format, GLenum type, void * data)
{
...
bool Texture::init(unsigned int width, unsigned int height, GLenum internalFormat, GLenum format, GLenum type, void * data)
{
...
bool Texture::init(unsigned int width, unsigned int height, unsigned int depth, GLenum internalFormat, GLenum format, GLenum type, void * data)
{
