...
{
	FxaaFloat2 fxaaQualityRcpFrame;
	fxaaQualityRcpFrame.x = u_resolution.x;
	fxaaQualityRcpFrame.y = u_resolution.y;

	FxaaFloat2 uv = gl_FragCoord.xy * u_resolution.xy;
	...
	gl_FragColor = FxaaPixelShader(uv, ConsolePosPos, u_colorTexture, u_colorTexture, u_colorTexture, fxaaQualityRcpFrame,
